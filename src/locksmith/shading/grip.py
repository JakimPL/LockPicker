...
from locksmith.blender.nodes import link_nodes, new_node, set_color_input, set_float_input
...
def make_grip_material(name: str, *, color: HexColor, config: GripConfig) -> Material:
