...
def build_flanges(
    *,
    ...
    for index, (fastener_x, fastener_z) in enumerate(placements):
        ...
        translate_vertices(mesh_builder, head_vertices, offset=(fastener_x, anatomy.head.y, fastener_z))
        ...
        translate_vertices(mesh_builder, slot_vertices, offset=(fastener_x, anatomy.slot.y, fastener_z))
