...
from locksmith.schema.models.anatomy.pick.ferrule import FerruleAnatomy
from locksmith.schema.models.anatomy.pick.grip import GripAnatomy
from locksmith.schema.models.anatomy.pick.shaft import ShaftAnatomy
